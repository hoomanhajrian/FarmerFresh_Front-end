    ...
    <div>
      ...
      <div className="Video">
        ...
        <div className="Video_Video">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/WhOrIUlrnPo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  );
