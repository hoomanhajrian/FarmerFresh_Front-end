        ...
        <Slide easing="ease">
          ...
          <div className="each-slide">
             <img src={slideImages[3]} />
              <p className="testimonialText">A few consumers buy produce from my farms and it's always hard to control stock operations manually. The Farmerfresh app gives us flexibility to control inventory operations and customize our own profile to look elegant.</p>
